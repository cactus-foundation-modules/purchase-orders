...
//
// Four kinds of file, all of them a plain Media id on a po_ table core has no
// sight of: a supplier's invoice attached to a bill, the proforma they sent
// before they would confirm an order, the acknowledgement they sent when they
// did, and the proof of payment we sent them. Without this the library would
// count every one of them as unused clutter and offer them up for a tidy.
//
